...
const RegistrationForm = () => {
  ...
  const handleRegistration = () => {
    ...
    // Check if user registered flag exists in localStorage (assuming it's set elsewhere)
    const userRegistered = localStorage.getItem(`${matchedUser.firstName}-${matchedUser.lastName}-registered`);
    ...
    // Set a flag in localStorage to indicate registration on this device
    localStorage.setItem(`${matchedUser.firstName}-${matchedUser.lastName}-registered`, true);
